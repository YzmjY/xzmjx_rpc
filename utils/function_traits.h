...
template <class Ret, class ClassType,class ... Args>
struct function_traits<Ret(ClassType::*)(Args...) const volatile> : function_traits<Ret(Args...)> {
};

template <class Ret, class ClassType,class ... Args>
struct function_traits<Ret(ClassType::*)(Args...) volatile> : function_traits<Ret(Args...)> {
};
