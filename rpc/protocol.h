...
public:
    ...
    static Protocol::ptr Create(Protocol::Type type,Context ctx,const std::string& content,uint64_t id = 0);
    static Protocol::ptr Create(Protocol::Type type, const std::string &content, uint64_t id = 0);
    ...
    std::string debugString() const {
        return fmt::format("[magic = {}, m_version = {}, type = {},err_code = {}, m_seq = {}, length = {}, payload = {}]"
        ,m_magic,m_version,(uint8_t)m_type,(uint8_t)(m_err_code)>>1,m_seq,m_payload_len,m_payload);
    }
